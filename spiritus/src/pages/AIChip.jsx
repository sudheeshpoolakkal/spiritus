        ...
        <svg viewBox="0 0 1000 1000" className="w-full h-full">
          ...
          <g opacity={intensity * 0.9}>
            ...
            <g transform={`translate(${700 + Math.sin(time * 0.8) * 10}, ${350})`}>
              <rect x="-60" y="-15" width="120" height="30" rx="15" fill="rgba(61, 90, 241, 0.2)" stroke={colors.accent[0]} strokeWidth="1" filter="url(#mainGlow)" />
              <text x="0" y="6" textAnchor="middle" fontSize="12" fontWeight="600" fill={colors.accent[0]} filter="url(#mainGlow)">
                Intelligent Core
              </text>
            ...
            <g transform={`translate(${300 + Math.sin(time * 1.2) * 8}, ${650 + Math.cos(time * 0.6) * 12})`}>
              <rect x="-55" y="-15" width="110" height="30" rx="15" fill="rgba(0, 212, 255, 0.2)" stroke={colors.accent[1]} strokeWidth="1" filter="url(#mainGlow)" />
              <text x="0" y="6" textAnchor="middle" fontSize="12" fontWeight="600" fill={colors.accent[1]} filter="url(#mainGlow)">
                Emotional Core
              </text>
            ...
            <g transform={`translate(${200 + Math.sin(time * 0.9) * 12}, ${180 + Math.cos(time * 1.1) * 8})`}>
              <rect x="-50" y="-15" width="100" height="30" rx="15" fill="rgba(96, 165, 250, 0.2)" stroke={colors.accent[2]} strokeWidth="1" filter="url(#mainGlow)" />
              <text x="0" y="6" textAnchor="middle" fontSize="12" fontWeight="600" fill={colors.accent[2]} filter="url(#mainGlow)">
                Wisdom Core
              </text>
