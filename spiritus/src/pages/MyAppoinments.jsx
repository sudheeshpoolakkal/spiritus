        ...
        {appointments.map((item, index) => (
          <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex flex-col gap-2 justify-end'>
              ...
              {item.isCompleted &&  <button className='w-auto px-4 py-2 border border-green-500 rounded text-green-500'>Completed</button>
              }
              ...
              {item.videoCallLink && shouldShowScheduledMessage(item.slotDate, item.slotTime) && (
                <p className="w-auto text-green-500 text-sm">Your meeting has been scheduled. The link will be visible 15 minutes before the appointment time.</p>
              )}
