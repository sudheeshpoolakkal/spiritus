...
const Contact = () => {
  ...
  const languages = [
    ...
    "Kannada", "Odia", "Dutch", "Swedish", "Norwegian", "Dutch", "Finnish", 
    "Polish", "Czech", "Hungarian", "Romanian", "Greek", "Turkish", "Hebrew", 
    "Thai", "Vietnamese", "Indonesian", "Malay", "Tagalog", "Swahili", "Other"
  ];
  ...
  const handleHospitalFormSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Hospital registration submitted successfully!");
      setHospitalFormData({
        hospitalName: "",
        type: "",
        yearEstablished: "",
    ...
    {showHospitalForm ? "Hide Facility Form" : "Enroll Facility"}
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8">
              ...
              {doctorFormSubmitted ? (
                <div className="p-8 text-center">
                  <div className="w-16 h-16 bg-blue-100 rounde d-full flex items-center justify-center mx-auto mb-4">
                ...
                <form onSubmit={handleDoctorFormSubmit} className="p-6">
                  ...
                  <div className="mt-6">
                    <label className="flex items-center">
                      <input
                        ...
                        required
                      />
                      I confirm the details provided are accurate and authorize the use of this data for the platform purposes
                    </label>
                  </div>
                  ...
                  <div className="mt-8">
                    <button
                      ...
                      className={`w-full py-3 rounded-lg font-semibold transition-all flex justify-center items-center ${
                        doctorFormLoading
                    ...
                    <p className="mt-2 text-sm text-gray-500 text-center">
                      * Required fields. We'll review your application within
                      2-3 business days.
                    </p>
                  </div>
                </form>
          ...
          {showHospitalForm && (
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="px-6 py-4 bg-[#0d8845] text-white">
                <h3 className="text-xl font-semibold">Hospital/Clinic Registration</h3>
                <p className="text-green-100 text-sm mt-1">
                  Join our network of trusted mental health institutions
                </p>
              </div>
              ...
              {hospitalFormSubmitted ? (
                <div className="p-8 text-center">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-[#0d8845] text-white rounded hover:bg-green-700 transition-colors"
                  >
                    Submit Another Registration
                  </button>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#0d8845]"
                        required
                      />
                    </div>
                    <div>
                      ...
                      >
                        ...
                        <option value="specialty">Specialty Psychiatric</option>
                    ...
                    <div>
                      <label htmlFor="keyContact" className="block text-sm font-medium text-gray-700 mb-1">
                        Key Contact Person (Name & Designation)
                      </label>
                      <input
                        type="text"
                        id="keyContact"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                      <label htmlFor="currentFees" className="block text-sm font-medium text-gray-700 mb-1">
                        Current Fees per Session *
                      </label>
                      <input type="text"
                        id="currentFees"
                        value={hospitalFormData.currentFees}
                        onChange={handleHospitalFormChange}
                        placeholder={`e.g., ${getSelectedCountryData('hospital').currency}500 - ${getSelectedCountryData('hospital').currency}1000`}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-[#0d8845]"
                        required
                      />
                    </div>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Do you provide emergency mental health/crisis support?
                      </label>
                      <div className="flex items-center gap-4">
                        <label className="flex items-center">
                          <input
                    ...
                    <div>
                      <label htmlFor="hospitalLicense" className="block text-sm font-medium text-gray-700 mb-1">
                        Upload Hospital License/Certificate *
                      </label>
                      <input
                        type="file"
                        id="hospitalLicense"
                  ...
                  <div className="mt-8">
                    <button
                      ...
                      className={`w-full py-3 rounded-lg font-semibold transition-all flex justify-center items-center ${
                        hospitalFormLoading
                          ? "bg-gray-400 cursor-not-allowed text-gray-200"
                          : "bg-[#0d8845] hover:bg-green-700 text-white shadow-md hover:shadow-lg"
                      }`}
                    >
                      {hospitalFormLoading ? (
                        <>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="w-full h-64 md:h-80 overflow-hidden rounded-md">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.52041014512!2d76.90376577602552!3d8.545851291497476!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05bec79541c519%3A0x98324eb5aafb3778!2sCollege%20of%20Engineering%20Trivandrum%20(CET)!5e0!3m2!1sen!2sin!4v1754676297209!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
