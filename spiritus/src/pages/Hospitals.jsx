...
import { FaStar, FaSearch, FaMapMarkerAlt, FaFilter, FaAmbulance } from 'react-icons/fa';
...
const Hospitals = () => {
  ...
  const calculateRating = (hospital) => {
    ...
    if (hospital.reviews && Array.isArray(hospital.reviews) && hospital.reviews.length > 0) {
      const avgRating =
        hospital.reviews.reduce((sum, review) => sum + (review.rating || 0), 0) /
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-12 py-6">
        <div className="flex gap-6">
          ...
          {showFilter && (
            <div
              className="sm:hidden fixed inset-0 z-50 bg-black bg-opacity-25"
              onClick={() => setShowFilter(false)}
            >
              <div
                className="bg-white rounded-t-xl mt-20 p-4"
          ...
          <section className="flex-1">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600">
                ...
                {filterHospitals.length === 1 ? 'hospital' : 'hospitals'}
              </p>
            </div>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-start gap-1.5 mb-3">
                          ...
                          <FaMapMarkerAlt className="h-3 w-3 text-green-700 mt-1 flex-shrink-0" />
                        </div>
