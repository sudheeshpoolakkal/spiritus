    ...
    return (
        <div className='bg-gradient-to-r from-hospitalBlue to-hospitalGreen text-white py-4 px-6 flex items-center justify-between shadow-md fixed top-0 left-0 w-full z-50'>
            ...
            <ul className='hidden md:flex items-center gap-6 text-sm font-semibold uppercase tracking-wide'>
                <NavLink to='/' className='text-black hover:text-blue-500 transition duration-300'>Home</NavLink>
                <NavLink to='/doctors' className=' text-black hover:text-blue-500 transition duration-300'>All Doctors</NavLink>
                <NavLink to='/about' className='text-black hover:text-blue-500 transition duration-300'>About</NavLink>
                <NavLink to='/contact' className='text-black hover:text-blue-500 transition duration-300'>Contact</NavLink>
            </ul>
