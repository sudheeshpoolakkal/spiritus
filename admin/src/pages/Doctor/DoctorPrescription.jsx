...
const DoctorPrescription = () => {
  ...
  // Destructure getAppointments from DoctorContext
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Refresh appointments to update the prescription data
      await getAppointments();
      // Redirect to the DoctorAppointments page after a brief delay
